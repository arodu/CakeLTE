<!DOCTYPE html>
<html lang="en" <?= $this->CakeLte->rtl() ?>> <!--begin::Head-->
...
<body class="sidebar-expand-lg bg-body-tertiary <?= $this->CakeLte->getBodyClass() ?>">
    <!--begin::App Wrapper-->
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
            <div class="sidebar-brand">
                <a href="<?= $this->Url->build('/') ?>" class="brand-link">
                    <?= $this->Html->image($this->CakeLte->getConfig('app-logo'), ['alt' => $this->CakeLte->getConfig('app-name') . ' logo', 'class' => 'brand-image opacity-75 shadow']) ?>
                    <span class="brand-text fw-light"><?= $this->CakeLte->getConfig('app-name') ?></span>
                </a>
            </div>
